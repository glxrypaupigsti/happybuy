        ...
        <section class="cartListWrap clearfix" id="cartsec{$product_list[i].product_id}">
            ...
            <div class="cartListDesc">
                ...
                <dl class="pd-dsc clearfix">
                    ...
                    <span class="productCountNum"><input  disabled="disabled" type='tel' data-mhash="p{$product_list[i].product_id}m{$product_list[i].spid}" data-prom-limit="{$product_list[i].product_prom_limit}" value='{$product_list[i].count}' class="dcount productCountNumi" /></span>
