...
<html>
    ...
    <body>
        ...
        <div id="categorySugg" class="clearfix"></div>
        
        <div id="buttomLoading"></div>
        
        <script data-main="{$docroot}static/script/Wshop/shop_vproductlist.js?v={$cssversion}" src="{$docroot}static/script/require.min.js"></script>
