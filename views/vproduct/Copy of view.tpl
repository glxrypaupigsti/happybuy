...
<html>
    ...
    <body>
        ...
        <div id="appCartWrap" class="clearfix">
            {if $productInfo.product_online eq 1}
                {if $productInfo.product_prom eq 0}<a class="button" id="addcart-button" data-prom="{$productInfo.product_prom}" data-add="1">加入购物车</a>{/if}
                <a class="button" id="buy-button" data-prom="{$productInfo.product_prom}" data-add="0" {if $productInfo.product_prom eq 1}style="width: 99%;"{/if}>立即购买</a>
            {else}
