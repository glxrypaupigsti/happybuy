    ...
    <body style="overflow:hidden;padding:0;-webkit-overflow-scrolling: none;">
        ...
        <div class="clearfix" id="viewCat">
            <div id="viewCatLeft">
                ...
                <div class="viewCatTopItem Elipsis" data-catid="-4">商品系列</div>
        ...
        <script data-main="{$docroot}static/script/Wshop/shop_vcategory.js?v={$cssversion}" src="{$docroot}static/script/require.min.js"></script>
    </body>
</html>