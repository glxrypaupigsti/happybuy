                ...
                {section name=oi loop=$orderlist}
                    <tr id='order-exp-{$orderlist[oi].order_id}'>
                        ...
                        <td>
                            ...
                            <a class="various fancybox.ajax" data-orderid="{$orderlist[oi].order_id}" data-fancybox-type="ajax" href="{$docroot}?/WdminAjax/printOrder/id={$orderlist[oi].order_id}">打印</a>
                        </td>
                        ...
                        <th class="gray font12">
                            ...
                            <a data-orderid="{$orderlist[oi].order_id}" class="notes fancybox.ajax" data-fancybox-type="ajax" href="{$docroot}?/WdminAjax/addOrderNotes/id={$orderlist[oi].order_id}">修改备注</a>
                        </th>
                    </tr>
                {/section}
            </tbody>
