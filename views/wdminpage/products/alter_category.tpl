        ...
        <div style="width:30%;margin-bottom: 10px;">
            ...
            <br/>
             <div>
                 <div>
                    <label>应用于商品类型:</label>
                    <input type="radio" name="cat_apply_to" value="0" {if $cat.cat_apply_to == 0}checked{/if}/>单品
                    <input type="radio" name="cat_apply_to" value="1" {if $cat.cat_apply_to == 1}checked{/if} />套餐
                 </div>
                 <br/>
                 <br/>
            </div>*}
            ...
            <div>
                <div>
                    <label>是否对外开放:</label>
                    <input type="radio" name="is_open" value="0" {if $cat.is_open == 0}checked{/if}/>否
                    <input type="radio" name="is_open" value="1" {if $cat.is_open == 1}checked{/if} />是
                </div>
                <br/>
                <br/>
            </div>
