        ...
        <div class="fv2Right">
            <div class="clearfix">
                <div style="width: 47%;float: left;">
                    ...
                    -->
                    <input type="text" class="gs-input" id="dt1" value="{$sec.ftime}" placeholer="点击设置开始时间" onClick="WdatePicker()" autofocus/>
                </div>
                <div style="width: 6%;float:left;text-align: center;line-height: 32px;text-indent: 3px;"> - </div>
                <div style="width: 47%;float: right;">
                    <input type="text" class="gs-input" id="dt2" value="{$sec.ttime}" placeholer="点击设置结束时间" onClick="WdatePicker()" autofocus/>
                </div>
            </div>
            <div class='fv2Tip'>板块名称，显示在板块顶部</div>
        </div>
