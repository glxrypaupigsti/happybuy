            ...
            <div id="exps">
                {foreach from=$datas item=data}
                    <div class="expfield">
                        ...
                        <span><a href="javascript:;" onclick="$(this).parent().parent().remove();">删除</a></span>
                    </div>
                {/foreach}
            </div>
            <div class="expprovince" id="expprovince">
                <div id="in"></div>
                <div style="text-align: center"><a class="wd-btn primary" id='saveBtnEx' style="width:150px" href="javascript:;">保存</a></div>
            </div>
