        ...
        <div class="r">
            ...
            <form id="ntright">
                ...
                <div style="padding:10px 20px;">
                    ...
                    <div id="nTop">
                        ...
                        <div id="act1" class="acts">
                            ...
                            <div style="width:500px;margin-bottom: 10px;">
                                ...
                                <!-- 图文选择 -->
                                <div id="appmsgItem1" class="js_appmsg_item" style="width:300px;margin-bottom: 10px;display: none;">
                                    <h4 class="appmsg_title"><a href="javascript:;">标题</a></h4>
                                    <div class="appmsg_info">
                                        <em class="appmsg_date"></em>
                                    </div>
                                    <a data-fancybox-type="ajax" class="fancybox.ajax appmsg_thumb_wrp pd-image-sec" id="thumbUp" 
                                       href="{$docroot}?/WdminPage/ajax_gmess_list/">
                                        <img class="js_appmsg_thumb appmsg_thumb" src="" id="appmsimg-preview" style="display: none;">
                                    </a>
                    ...
                    <a id="menu_savebtn" style="margin-left:0;margin-bottom: 10px;" href="javascript:;" class="wd-btn primary">保存</a>
                </div>
            </form>
        </div>
    </div>
...
<div class="fix_bottom fixed">
    <a id="menu_pubbtn"  href="javascript:;" class="wd-btn primary">发布</a>
    <a onclick="location.href = window.location.href;" class="wd-btn default">刷新菜单</a>
    <a id="menu_delete"  href="javascript:;" class="wd-btn delete">清空菜单</a>
</div>
