...
<i id="scriptTag">page_checkin_ingredient</i>
    ...
    <div style="padding: 22px;" class="clearfix">
        <div>
            ...
            <div class="fv2Field clearfix">
                ...
                <div class="fv2Right">
                    <input type="text" class="gs-input" style="width:60%; margin-right:10px;" name="change_price" placeholder="￥0.00" "value="0" autofocus/>元
                </div>
            </div>
            <div class="fv2Field clearfix">
                <div class="fv2Left">
