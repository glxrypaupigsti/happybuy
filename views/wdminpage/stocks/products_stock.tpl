...
<i id="scriptTag">page_stocks_products</i>

<div id="products-stock-list" class="dataTables_wrapper no-footer" style="margin-bottom: 54px;">
    <div class="dataTables_filter clearfix">
        ...
        <div class="button-set">
            ...
            <a class="button" href="?/WdminPage/add_product_stock">添加记录</a>
        </div>
    </div>
    <table class="dTable">
        <thead>
