...
<html>
    <head>
        ...
        <link href="{$docroot}static/script/DataTables/media/css/dataTables.bootstrap.min.css" type="text/css" rel="Stylesheet" />
       	<link href="{$docroot}static/script/DataTables/media/css/jquery.dataTables_themeroller.css" type="text/css" rel="Stylesheet" />
       	-->
