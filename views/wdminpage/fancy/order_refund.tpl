<div style="width:550px;">
    ...
    <div style="text-align: center;padding-top:10px;" class='clearfix'>
        <div><input type="text" class="gs-input" id='despatchExpressCode' value="{$data.online_amount}" style='float:left;width:30%;margin:0;padding:0;'  disabled="disabled" />
        <input type="text" class="gs-input" id='balance' value="{$data.balance_amount}" style='float:left;width:30%;margin:0;padding:0;'  disabled="disabled" />
        </div>
