...
/**
 * Description of AddressApart
 *
 * @author Administrator
 */
class AddressApart extends Model {

    const ADDR_TYPE_FULL = 1;
    const ADDR_TYPE_SIMP = 2;

    //put your code here
    public function apart($addr, $type = self::ADDR_TYPE_FULL) {
        /*         * -
         * 省市区地址分割
         ...
         */
        $address = include(dirname(__FILE__) . "/addressapart-master/address.info$type.php");
        $cache_file = dirname(__FILE__) . "/addressapart-master/lenarr.cache$type.php";
