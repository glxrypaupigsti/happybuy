...
class FancyPage extends Controller {
     ...
     * @param type $Q
     */
    public function fancyHint($Q) {
    	$this->Smarty->assign('id', $Q->id);
    	$this->Smarty->assign('title', urldecode($Q->title));
    	$this->show(self::TPL . 'fancy_hint.tpl');
    }
     ...
     * @param unknown $Q 
     **/
    public function batch_send_wechat_msg($Q){
    	$this->Smarty->assign('open_ids', $Q->open_ids);
    	$this->show(self::TPL . 'fancy_batch_send_wechat_msg.tpl');
    }
