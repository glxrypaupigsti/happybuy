...
requirejs(['util', 'fancyBox', 'datatables', 'Spinner', 'jUploader', 'ztree', 'ztree_loader'], function (util, fancyBox, dataTables, Spinner, jUploader, ztree, treeLoader) {
    ...
    $.jUploader({
        ...
        action: shoproot + '?/WdminAjax/BannerImageUpload/',
        onComplete: function (fileName, response) {
            if (response.s > 0) {
                $('#banner_image').val(response.img);
