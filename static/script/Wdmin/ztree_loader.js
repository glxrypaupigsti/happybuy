...
define(['jquery', 'ztree'], function($, ztree) {
    ...
    function treeLoader() {
        ...
        this.setting = {
            ...
            callback: {
                // treeNode点击事件 生成面包屑导航|重新加载列表
                onClick: function(event, treeId, treeNode) {

//                    if (treeNode !== null && !self.editing) {
//                        var nav = [];
//                        if (treeNode !== null) {
//                            nav.push(treeNode.name);
//                            var parentNode = self.zTreeObj.getNodeByParam('dataId', treeNode.parentId);
//                            if (parentNode !== null)
//                                nav.push(parentNode.name);
//                            while (parentNode !== null) {
//                                parentNode = self.zTreeObj.getNodeByParam('dataId', parentNode.parentId);
//                                if (parentNode !== null)
//                                    nav.push(parentNode.name);
//                            }
//                            nav.push("要点");
//                            nav = nav.reverse();
//                            $('.basePointTreeNav').html(nav.join(' > '));
//                        }
//                        if (treeNode.dataId !== false)
//                            TreeLoader.reloadData(treeNode.dataId);
//                    }
                },
                // 修改完成前数据处理，包括新建和编辑数据
